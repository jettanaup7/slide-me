...
function ProcessPayment({ fetchOrders, token }) {
    ...
    return (
        <div className="propayment-container">
            ...
            <div className="location-container-pp">
                <div>
                    <h5>
            ...
            <div className="price-container">
                <span>ค่าบริการ</span>
                <span className="price-thai" style={{ fontWeight: "bold" }}>{isLoading ? "Loading..." : (Number(selectedOrder.amount)).toLocaleString()}฿</span>
            ...
            <div className="button-container">
                <Button onClick={handleStartJob} disabled={paymentStatus === 'รอชำระเงิน'} variant="success" className="rounded-pill" size="lg" >
                    เริ่มงาน
                </Button>
            </div>
        </div>
